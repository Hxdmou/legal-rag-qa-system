...
def add_tech_elements(slide):
    ...
    # 添加多个AI节点（圆形）
    ai_nodes = [
        (Inches(0.5), Inches(2), Inches(0.4), RGBColor(0, 200, 255)),
        (Inches(9.5), Inches(3), Inches(0.5), RGBColor(150, 100, 255)),
        (Inches(1), Inches(6), Inches(0.3), RGBColor(0, 255, 150)),
        (Inches(10), Inches(5), Inches(0.4), RGBColor(255, 150, 100)),
        (Inches(5), Inches(0.5), Inches(0.3), RGBColor(200, 100, 255)),
        (Inches(5), Inches(7), Inches(0.35), RGBColor(100, 200, 255)),
    ]
    ...
    # 添加六边形芯片元素
    hexagons = [
        (Inches(0.3), Inches(4), Inches(0.4), RGBColor(120, 80, 200)),
        (Inches(10.2), Inches(4), Inches(0.4), RGBColor(80, 150, 200)),
        (Inches(2), Inches(7), Inches(0.3), RGBColor(100, 180, 150)),
    ]
    ...
    # 添加连接线（技术数据流）
    # 水平线
    line1 = slide.shapes.add_shape(MSO_SHAPE.LINE, Inches(1), Inches(2.2), Inches(2), Inches(0))
    line1.line.color.rgb = RGBColor(0, 200, 255)
    line1.line.width = Pt(1.5)
    
    # 斜线
    line2 = slide.shapes.add_shape(MSO_SHAPE.LINE, Inches(9.7), Inches(3.2), Inches(0), Inches(1.5))
    line2.line.color.rgb = RGBColor(150, 100, 255)
...
def create_full_pptx():
    ...
    # 设置幻灯片大小为标准16:9
    prs.slide_width = Inches(11.69)  # 标准宽屏
    ...
    big_circle.shadow.inherit = False
