...
def add_tech_elements(slide):
    ...
    fill.solid()
    fill.fore_color.rgb = RGBColor(8, 8, 25)
    
    # 添加多个AI节点（圆形）- 更多科技元素
    ai_nodes = [
        (Inches(0.5), Inches(1.5), Inches(0.4), RGBColor(0, 200, 255)),
        (Inches(10), Inches(2), Inches(0.5), RGBColor(150, 100, 255)),
        (Inches(1), Inches(5), Inches(0.3), RGBColor(0, 255, 150)),
        (Inches(10.5), Inches(5.5), Inches(0.4), RGBColor(255, 150, 100)),
        (Inches(5.5), Inches(0.3), Inches(0.3), RGBColor(200, 100, 255)),
        (Inches(5.5), Inches(6.2), Inches(0.35), RGBColor(100, 200, 255)),
        (Inches(2), Inches(3), Inches(0.25), RGBColor(150, 200, 100)),
        (Inches(9), Inches(4), Inches(0.3), RGBColor(200, 150, 200)),
        (Inches(0.8), Inches(4), Inches(0.2), RGBColor(100, 150, 200)),
        (Inches(10.2), Inches(3), Inches(0.25), RGBColor(180, 180, 100)),
    ]
    
    for left, top, size, color in ai_nodes:
    ...
    # 添加六边形芯片元素
    hexagons = [
        (Inches(0.3), Inches(3), Inches(0.4), RGBColor(120, 80, 200)),
        (Inches(10.5), Inches(3.5), Inches(0.4), RGBColor(80, 150, 200)),
        (Inches(2), Inches(6), Inches(0.3), RGBColor(100, 180, 150)),
        (Inches(9), Inches(5.8), Inches(0.35), RGBColor(180, 100, 180)),
    ]
    
    for left, top, size, color in hexagons:
        hexagon = slide.shapes.add_shape(MSO_SHAPE.HEXAGON, left, top, size, size)
        hexagon.fill.solid()
        hexagon.fill.fore_color.rgb = color
        hexagon.line.fill.background()
    
    # 添加菱形元素（数据节点）
    diamonds = [
        (Inches(4), Inches(6.3), Inches(0.3), RGBColor(150, 200, 255)),
        (Inches(7), Inches(0.5), Inches(0.25), RGBColor(255, 150, 200)),
    ]
    
    for left, top, size, color in diamonds:
...
def create_full_pptx():
    ...
    fill = background.fill
    fill.solid()
    fill.fore_color.rgb = RGBColor(5, 5, 20)
    
    # 添加封面装饰元素
    # 大圆形背景
    big_circle = slide.shapes.add_shape(MSO_SHAPE.OVAL, Inches(2.5), Inches(1.5), Inches(6), Inches(6))
    big_circle.fill.solid()
    big_circle.fill.fore_color.rgb = RGBColor(0, 50, 80)
    big_circle.line.fill.background()
    
    # 添加多个装饰圆
    small_circles = [
        (Inches(1), Inches(2), Inches(0.3), RGBColor(0, 150, 200)),
        (Inches(10), Inches(3), Inches(0.4), RGBColor(100, 80, 180)),
        (Inches(3), Inches(6), Inches(0.25), RGBColor(0, 200, 150)),
        (Inches(8), Inches(6), Inches(0.3), RGBColor(200, 100, 150)),
        (Inches(0.5), Inches(4), Inches(0.2), RGBColor(150, 200, 100)),
        (Inches(10.5), Inches(5), Inches(0.25), RGBColor(180, 150, 200)),
    ]
    
    for left, top, size, color in small_circles:
        circle = slide.shapes.add_shape(MSO_SHAPE.OVAL, left, top, size, size)
        circle.fill.solid()
        circle.fill.fore_color.rgb = color
        circle.line.fill.background()
    ...
    # 项目9表格只有8列
    cols_9 = 8
    table = slide.shapes.add_table(11, cols_9, left, top, width, height).table
    table.autofit = False
    col_width_9 = width / cols_9
    for col in range(cols_9):
        table.columns[col].width = col_width_9
    ...
    # 项目10表格只有4列
    cols_10 = 4
    table = slide.shapes.add_table(12, cols_10, left, top, width, height).table
    table.autofit = False
    col_width_10 = width / cols_10
    for col in range(cols_10):
        table.columns[col].width = col_width_10
    ...
    print(f"✅ 已创建完整科技版PPT！保存到: {output_path}")
