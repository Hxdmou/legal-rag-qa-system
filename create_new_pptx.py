...
def create_new_pptx():
    ...
    subtitle.text = "A2A协议与AI智能体 - 完整版"
    
    # 项目2：价值维度
    slide_layout = prs.slide_layouts[1]
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目2：价值维度"
    table = slide.shapes.add_table(16, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目3：协议层级
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目3：协议层级"
    table = slide.shapes.add_table(14, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目4：安全组件
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目4：安全组件"
    table = slide.shapes.add_table(17, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目5：部署策略
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目5：部署策略"
    table = slide.shapes.add_table(17, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目6：优化维度
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目6：优化维度"
    table = slide.shapes.add_table(13, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目7：案例场景
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目7：案例场景"
    table = slide.shapes.add_table(11, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目8：技术方案对比
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目8：技术方案对比"
    table = slide.shapes.add_table(11, 9, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目9：市场预测
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目9：市场预测（2026-2035年）"
    table = slide.shapes.add_table(11, 8, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
    ...
    # 项目10：总结与规划
    slide = prs.slides.add_slide(slide_layout)
    slide.shapes.title.text = "项目10：总结与未来规划"
    table = slide.shapes.add_table(12, 4, Inches(0.5), Inches(1.5), Inches(10), Inches(5)).table
    data = [
        ["项目", "核心内容", "当前状态", "未来规划"],
        ["项目1", "封面设计", "完成", "季度更新"],
        ["项目2", "价值维度", "完成", "持续优化"],
    ...
    # 保存
    output_path = r"f:\个人作品\legal-rag-qa-system\A2A_PROTOCOL_AI_AGENT_2026_全新完整版.pptx"
    prs.save(output_path)
    print(f"✅ 已创建全新PPT！保存到: {output_path}")
