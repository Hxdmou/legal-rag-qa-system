...
def add_tech_elements(slide):
    ...
    fill.gradient_stops[0].color.rgb = RGBColor(10, 10, 30)
    fill.gradient_stops[1].color.rgb = RGBColor(30, 20, 60)
    fill.gradient_stops[2].color.rgb = RGBColor(20, 10, 40)
    ...
    shape.shadow.offset_x = Pt(0)
    shape.shadow.offset_y = Pt(0)
    shape.shadow.blur_radius = Pt(20)
    shape.shadow.fore_color.rgb = RGBColor(0, 200, 255)
    ...
    width = Inches(0)
    height = Inches(0.5)
    line = slide.shapes.add_shape(MSO_SHAPE.LINE, left, top, width, height)
    line.line.color.rgb = RGBColor(0, 200, 255)
...
def create_tech_pptx():
    ...
    fill.gradient_stops[0].color.rgb = RGBColor(5, 5, 20)
    fill.gradient_stops[1].color.rgb = RGBColor(20, 10, 50)
    fill.gradient_stops[2].color.rgb = RGBColor(10, 5, 30)
    ...
    circle.fill.solid()
    circle.fill.fore_color.rgb = RGBColor(0, 100, 150)
    circle.line.fill.background()
    circle.shadow.inherit = False
    circle.shadow.offset_x = Pt(0)
    circle.shadow.offset_y = Pt(0)
    circle.shadow.blur_radius = Pt(40)
    circle.shadow.fore_color.rgb = RGBColor(0, 200, 255)
    circle.shadow.transparency = 0.5
