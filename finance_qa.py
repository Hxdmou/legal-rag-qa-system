...
def interactive():
    ...
    st.markdown("""
        ...
        * { font-family: 'Inter', sans-serif; }
        .main-header { background: linear-gradient(135deg, #ff7043 0%, #ff5722 100%); padding: 2.5rem; border-radius: 16px; margin-bottom: 2rem; box-shadow: 0 10px 40px rgba(255, 112, 67, 0.3); }
        ...
        .feature-card { background: linear-gradient(145deg, #ffffff, #fbe9e7); border: 1px solid #ffccbc; border-radius: 12px; padding: 1.2rem; margin-bottom: 1rem; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
        .feature-card:hover { transform: translateY(-2px); box-shadow: 0 8px 25px rgba(255, 112, 67, 0.15); border-color: #ff7043; }
        .feature-title { color: #e64a19; font-size: 1.15rem; font-weight: 600; margin-bottom: 0.5rem; }
        ...
        .source-card { background: #f8f9fa; border-left: 3px solid #ff7043; padding: 0.75rem; margin: 0.5rem 0; border-radius: 0 8px 8px 0; font-size: 0.85rem; }
        </style>
    ...
    st.markdown("""<div class="disclaimer-card"><h4>⚠️ 金融风险提示</h4><p style="font-size: 0.85rem; color: #555; margin: 0;">本系统提供的信息仅供参考，不构成投资建议。投资有风险，决策需谨慎。</p></div>""", unsafe_allow_html=True)
