    ...
    projects = [
        {"title": "项目1：A2A协议核心架构演进（2026-2035）",
            ...
            "data": [
                ...
                ["2026 Q1", "技术突破", "架构组", "应用层", "GPT-5.0/DeepSeek-V5/Qianwen-3.6/Claude-3.5-Sonnet/Gemini-2.5-Flash", "LangChain v0.1.x + RAG v3.0.0 + LlamaIndex", "延迟<10ms | QPS>50万 | 吞吐量>10万 req/s", "长上下文理解、多模态对齐", "优化Transformer架构、动态上下文管理", "【突破】完成RAG v3.0.0升级；【事件】多模态API发布；【未达成】长上下文理解未达预期；【展望】Q2实现智能问答落地", "多模态融合"],
                ["2026 Q2", "应用场景", "研发组", "应用层", "GPT-5.0/DeepSeek-V5/Qianwen-3.6/Claude-3.5-Sonnet/Gemini-2.5-Flash", "LangChain v0.1.x + RAG v3.0.0 + LlamaIndex", "推理延迟<50ms | 吞吐量>5万 req/s", "推理效率、知识库更新", "LoRA微调、增量索引", "【突破】智能问答准确率95%+；【事件】企业版发布；【未达成】知识库更新效率低；【展望】Q3推出Agent平台", "智能问答"],
