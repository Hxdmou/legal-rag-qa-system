...
def create_full_pptx(add_watermark_flag=True, output_filename="output.pptx"):
    ...
    title.text = "A2A PROTOCOL 2.0: AI AGENT EVOLUTION ROADMAP 2026-2045"
    ...
    subtitle.text = "GPT-5.0/6.0/7.0 · DeepSeek-V5/V6 · 量子计算融合 · AGI超级智能 · 神经接口 · 数字永生 · 星际探索"
    ...
    projects = [
        ...
        {"title": "项目11：总结与未来规划（2026-2045）",
            "bg_color": RGBColor(30, 20, 50),
            "header_color": RGBColor(106, 27, 154),
            "accent_color": RGBColor(180, 100, 255),
            "data": [
                ["项目", "核心内容", "AI模型", "状态", "第一阶段(2026-2030)", "第二阶段(2031-2035)", "第三阶段(2036-2045)", "关键指标", "关键亮点", "技术标准", "合规认证", "性能基准", "生态伙伴", "专利数量", "研发投入(亿)"],
...
if __name__ == "__main__":
    create_full_pptx(add_watermark_flag=False, output_filename="A2A_PROTOCOL_AI_AGENT_2026_V13_无水印.pptx")
    print("无水印版本已生成")
    create_full_pptx(add_watermark_flag=True, output_filename="A2A_PROTOCOL_AI_AGENT_2026_V13_带水印.pptx")
    print("带水印版本已生成")