...
def main():
    ...
    st.markdown('<h1 class="main-header">🏛️ 政务服务智能问答系统</h1>', unsafe_allow_html=True)
    st.markdown('<p class="sub-header">基于RAG技术的政务服务知识问答平台，支持商品咨询、购物指南、售后服务等</p>', unsafe_allow_html=True)
