...
SYSTEM_NAME = "tech"
DEFAULT_INDEX_DIR = "tech_faiss_index"
...
def interactive():
    ...
    with col2:
        ...
        features = [
            ("📄 文档支持", "支持上传API文档、技术手册、代码说明等"),
            ("💬 智能问答", "基于技术文档进行编程问题解答"),
            ("💻 代码示例", "提供完整的代码示例和说明"),
            ("🏗️ 架构设计", "技术方案咨询和架构设计建议"),
            ("� 历史记录", "对话记录本地存储，随时查看"),
